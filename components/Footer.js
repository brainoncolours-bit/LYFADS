...
export default function LyfAdsFooter() {
  return (
    <footer className="bg-[#fafafa] text-neutral-900 font-sans border-t border-neutral-200/80 p-6 md:p-12 selection:bg-red-600 selection:text-white">
      <div className="max-w-7xl mx-auto w-full flex flex-col justify-between gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-7 flex flex-col gap-4">
            ...
            <img src="/bg.png" width="160" alt="Lyf Ads Logo" className="brightness-100" />
          </div>
          ...
          <div className="md:col-span-5 flex flex-col gap-2 md:items-end">
            ...
            <ul className="flex flex-col gap-1 text-sm font-bold uppercase tracking-wider text-neutral-800 md:text-right">
        ...
        <div className="border-y border-neutral-200/80 py-6 overflow-hidden select-none">
          <div className="whitespace-nowrap animate-marquee">
            <span className="text-2xl md:text-4xl font-black italic tracking-tighter text-neutral-300 uppercase">
